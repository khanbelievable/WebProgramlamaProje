...
<style>
  img { max-height: 250px; display: block; margin: 0 auto; }
  h3 { margin-top: 20px; }
  hr { margin: 15px 0; }
</style>
...
- **GitHub:** [https://github.com/khanbelievable/WebProgramlamaProje](https://github.com/khanbelievable/WebProgramlamaProje)
...
### 6. EKRAN GÖRÜNTÜLERİ VE KULLANIM

**6.1. Ana Sayfa (Dashboard)**
![Ana Sayfa](ana_sayfa.png)

**6.2. Spor Salonları Yönetimi**
![Salonlar](salonlar.png)

**6.3. Eğitmen Profilleri**
![Eğitmenler](egitmenler.png)

**6.4. Randevu Sistemi**
![Randevular](randevular.png)

**6.5. AI Egzersiz Asistanı**
![AI Öneri](ai_oneri.png)
